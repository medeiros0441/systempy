...
class views_api:
    ...
    def buscar_lojas(request):
        ...
        associacao = Associado.objects.filter(usuario_id=id_usuario, status_acesso=True)
    ...
    def create_endereco(request):
        if request.method == "POST":
            ...
            try:
                ...
                return JsonResponse(
                    {"message": "Endereco created successfully"}, endereco, status=201
                )
    ...
    def update_endereco(request, endereco_id):
        if request.method == "PUT":
            ...
            try:
                ...
                endereco.codigo_postal = data.get(
                    "codigo_postal", endereco.codigo_postal
                )
