def corpo_email(
    ...
    <div style="text-align: center;">
        <img alt="Logo da Empresa" style="width: 100%;" src="https://comercioprime.azurewebsites.net/static/media/biblioteca/name-empresa.png">
        <br>
    </div>
    ...
    <div style="text-align:center;background: #000000;border: none; ;font-size: 10px;color: white;margin:10px 0 0 0">
        ...
        <img alt="Logo da Empresa" style="width: 100%" src="https://comercioprime.azurewebsites.net/static/media/banner-frase.png">
        <br>
